    ...
    >
      ...
      <View className="flex-row items-center gap-4">
        ...
        >
          ...
          />
          <Text
            className={`text-xs ${helped ? "text-green-400" : "text-outline"}`}
          >
...
const ReplySection = ({ replyText, setReplyText }) => {
  return (
    <View
      className="px-4 pt-3 border-t border-outline-variant/30 flex-row items-center gap-3"
      style={{ paddingBottom: Platform.OS === "android" ? 16 : 8 }}
    >
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => router.back()}
            className="flex-row items-center gap-1 px-5  my-4 "
          >
            <Ionicons name="arrow-back-outline" size={18} color="#8c909f" />
            <Text className="text-outline text-md">Back to Discussions</Text>
          </TouchableOpacity>
                ...
                <View className="bg-primary/5 border border-primary/20 rounded-xl p-4 mb-4">
                  <View className="flex-row items-center gap-2 mb-2">
                    <View className="bg-primary/10 rounded-md px-2 py-0.5">
                      <Text className="text-primary text-xs font-semibold tracking-wider">
                        AI SUMMARY
                      </Text>
                    </View>
                  </View>
        ...
        <ReplySection replyText={replyText} setReplyText={setReplyText} />
      </KeyboardAvoidingView>
    </SafeAreaView>
  );
}
